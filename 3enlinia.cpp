		...
		/* Joc de tres en línia	per Miquel A. Cabot */
...
if (n_fitxes==0)
	...
	{          		//tapar el possible 3 en línia del jugador
	for (i=0;i<9;i++)
	...
	{
	for (i=0;i<9;i++)	//cercar si es pot fer 3 en línia
...
settextstyle(1,0,5);
setcolor(5);
outtextxy(100,100,"Joc de tres en línia");
settextstyle(1,0,3);
setcolor(15);
